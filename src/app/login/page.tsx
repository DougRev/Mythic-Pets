...
import { PawPrint, Mail, KeyRound, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          ...
          <CardDescription>Log in to continue your pet's saga.</CardDescription>
        </CardHeader>
        <CardContent>
          <form className="space-y-4" onSubmit={handleLogin}>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="hero@example.com" required className="pl-10" />
              </div>
            </div>
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <Button variant="outline"><AppleIcon className="mr-2 h-4 w-4" fill="currentColor"/>Apple</Button>
          </div>
        </CardContent>
